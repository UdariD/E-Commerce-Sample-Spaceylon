...
import static qa.ecomm.spacln.config.ConfigurationManager.config;
 ...
 *
 * This project makes use of the drivers - chrome, firefox and safari currently. So, this enum
